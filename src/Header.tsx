...
const Header = () => {
    ...
    return(
        <header className="flex place-content-between md:place-content-start md:items-center md:gap-6 lg:gap-10 pt-10 pb-5 px-6 md:px-10 lg:px-24 xl:px-40 relative text-white">
            <a href="/">
            ...
            <nav className="md:grow">
                <button onClick={toggleNav} className="relative w-7 h-5 md:hidden"><div className="hamburger-div"></div></button>
                <ul className={`absolute top-full inset-x-6 h-auto 
                               font-bold bg-clr-Dark-Violet py-6 
                               place-content-center text-center rounded-lg 
                               ${expanded ? 'block' : 'hidden'} 
                               md:flex md:static md:bg-white md:p-0
                               md:items-center md:text-clr-Grayish-Violet
                               md:gap-6 lg:gap-10 md:font-medium
                               text-base font-bold md:ml-4`
                               }>
                    <li className="w-full md:w-fit"><a className="py-3 block hover:text-red-500 md:hover:text-black md:p-0" href="/#">Features</a></li>
                    <li className="w-full md:w-fit"><a className="py-3 block hover:text-red-500 md:hover:text-black md:p-0" href="/#"> Pricing</a></li>
                    <li className="w-full md:w-fit pb-5 md:p-0"><a className="py-3 block hover:text-red-500 md:hover:text-black md:p-0" href="/#"> Resources</a></li>
                    <li className="w-full md:w-fit relative pt-5 md:p-0 after:absolute after:inset-x-6 after:top-0 after:h-thin-line after:rounded-lg after:opacity-25 after:bg-white md:ml-auto"><a className="py-3 block hover:text-red-500 md:hover:text-black md:p-0" href="/#"> Login</a></li>
                    <li className="w-full md:w-fit pt-3 pb-3 md:p-0"><button className="relative bg-clr-cyan hover:bg-teal-200 w-5/6 md:w-max md:text-white md:px-8 md:m-0 py-2 mx-4 rounded-full">Sign Up</button></li>
                </ul>
            </nav>
        </header>
    )
